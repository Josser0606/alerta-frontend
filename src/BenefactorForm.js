...
function BenefactorForm({ onClose }) {
    ...
    // Estado inicial con todos los campos vacíos
    const [formData, setFormData] = useState({
        ...
        direccion: '', // Se puede ampliar a Departamento/Ciudad si se desea separar
        empresa: '',
        cargo: '',
        estado_civil: '',
        conyuge: '',
        ...
        contacto_saciar: '',
        estado: '',
        autorizacion_datos: '', // Fecha o "No"
        fecha_rut_actualizado: '', // Fecha o "No"
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            window.location.reload(); // Recargar para ver los cambios (opcional)
        ...
        <div className="modal-overlay">
            <div className="modal-content">
                ...
                <form onSubmit={handleSubmit} className="benefactor-form-grid">
                    ...
                    {/* 12. Contacto */}
                    <div className="form-group">
                        <label>12. Tipo Contacto *</label>
                        <select name="tipo_contacto" value={formData.tipo_contacto} onChange={handleChange} required>
                    ...
                    <div className="form-group">
                        <label>Número *</label>
                        <input type="number" name="numero_contacto" value={formData.numero_contacto} onChange={handleChange} required />
                    </div>
                    ...
                    {/* 15. Dirección */}
                    <div className="form-group full-width">
                        <label>15. Dirección (con Ciudad/Depto) *</label>
                        <input type="text" name="direccion" value={formData.direccion} onChange={handleChange} required placeholder="Ej: Cra 50 #25-26, Medellín, Antioquia" />
                    </div>
